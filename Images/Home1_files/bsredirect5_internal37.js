...
0;d.height=0;d.id=c;d.style.display="none";d.src=b;return d}function G(b,c,d){d=d||150;var f=window._dv_win||window;if(f.document&&f.document.body)return c&&c.parentNode?c.parentNode.insertBefore(b,c):f.document.body.insertBefore(b,f.document.body.firstChild),!0;if(0<d)setTimeout(function(){G(b,c,--d)},20);else return!1}function S(b){var c=null;try{if(c=b&&b.contentDocument)return c}catch(d){}try{if(c=b.contentWindow&&b.contentWindow.document)return c}catch(d){}try{if(c=window._dv_win.frames&&window._dv_win.frames[b.name]&&
window._dv_win.frames[b.name].document)return c}catch(d){}return null}function T(){function b(c){d++;var g=c.parent==c;return c.mraid||g?c.mraid:20>=d&&b(c.parent)}var c=window._dv_win||window,d=0;try{return b(c)}catch(f){}}function L(b,c,d,f,g,e,k,h,m){var B=window._dv_win.dv_config&&window._dv_win.dv_config.bst2tid?window._dv_win.dv_config.bst2tid:dv_GetRnd();var x=window.parent.postMessage&&window.JSON,l=!0,n=!1;if("0"==dv_GetParam(b.dvparams,"t2te")||window._dv_win.dv_config&&1==window._dv_win.dv_config.supressT2T)n=
!0;if(x&&0==n)try{n="https://cdn3.doubleverify.com/bst2tv3.html";window._dv_win&&window._dv_win.dv_config&&window._dv_win.dv_config.bst2turl&&(n=window._dv_win.dv_config.bst2turl);var u=K(n,"bst2t_"+B);l=G(u)}catch(F){}var v=(n=(/iPhone|iPad|iPod|\(Apple TV|iOS|Coremedia|CFNetwork\/.*Darwin/i.test(navigator.userAgent)||navigator.vendor&&"apple, inc."===navigator.vendor.toLowerCase())&&!window.MSStream)?"https:":J(k.src),D="0";"https:"==v&&(D="1");u=b.rand;var A="__verify_callback_"+u,p="__tagObject_callback_"+
u;U(A,b);V(p,k,b,n);void 0==b.dvregion&&(b.dvregion=0);var C="";u=k="";try{for(var r=d,y=0;10>y&&r!=window.top;)y++,r=r.parent;d.depth=y;dv_additionalUrl=W(d);k="&aUrl="+encodeURIComponent(dv_additionalUrl.url);u="&aUrlD="+dv_additionalUrl.depth;C=d.depth+f;g&&d.depth--}catch(F){u=k=C=d.depth=""}void 0!=b.aUrl&&(k="&aUrl="+b.aUrl);f=X();g=window._dv_win&&window._dv_win.dv_config&&window._dv_win.dv_config.verifyJSCURL?dvConfig.verifyJSCURL+"?":v+"//rtb"+b.dvregion+".doubleverify.com/verifyc.js?";a:{v=
window._dv_win;r=0;try{for(;10>r;){if(v.maple&&"object"===typeof v.maple){var z=!0;break a}if(v==v.parent){z=!1;break a}r++;v=v.parent}}catch(F){}z=!1}b=g+b.dvparams+"&num=5&srcurlD="+d.depth+"&callback="+A+"&jsTagObjCallback="+p+"&ssl="+D+(n?"&dvf=0":"")+(z?"&dvf=1":"")+"&refD="+C+"&htmlmsging="+(x?"1":"0")+"&guid="+B+(null!=f?"&aadid="+f:"");c="dv_url="+encodeURIComponent(c);if(0==l||e)b=b+("&dvp_isBodyExistOnLoad="+(l?"1":"0"))+("&dvp_isOnHead="+(e?"1":"0"));T()&&(b+="&ismraid=1");h&&(b+="&dvp_sfr=1");
m&&(b+="&dvp_sfe=1");if((e=window[H("=@42E:@?")][H("2?46DE@C~C:8:?D")])&&0<e.length){h=[];h[0]=window.location.protocol+"//"+window.location.hostname;for(m=0;m<e.length;m++)h[m+1]=e[m];e=h.reverse().join(",")}else e=null;e&&(c+="&ancChain="+encodeURIComponent(e));if(0==/MSIE (\d+\.\d+);/.test(navigator.userAgent)||7<new Number(RegExp.$1)||2E3>=k.length+u.length+b.length)b+=u,c+=k;if(void 0!=window._dv_win.$dvbsr.CommonData.BrowserId&&void 0!=window._dv_win.$dvbsr.CommonData.BrowserVersion&&void 0!=
...
0,{}));c.hasOwnProperty("err")&&(b=c.err);return{vdcv:26,vdcd:c.res,err:b}}catch(d){return{vdcv:26,vdcd:"0",err:b}}}function N(b){var c=0,d;for(d in b)b.hasOwnProperty(d)&&++c;return c}function ca(b,c){a:{var d={};try{if(b&&b.performance&&b.performance.getEntries){var f=b.performance.getEntries();for(b=0;b<f.length;b++){var g=f[b],e=g.name.match(/.*\/(.+?)\./);if(e&&e[1]){var k=e[1].replace(/\d+$/,""),h=c[k];if(h){for(var m=0;m<h.stats.length;m++){var B=h.stats[m];d[h.prefix+B.prefix]=Math.round(g[B.name])}delete c[k];
if(!N(c))break}}}}var x=d;break a}catch(l){}x=void 0}if(x&&N(x))return x}function V(b,c,d,f){var g=f?"https:":O(),e=f?"https:":J(c.src),k="0";"https:"===e&&(k="1");var h=window._dv_win.document.visibilityState;window[b]=function(b){try{var f={};f.protocol=g;f.ssl=k;f.dv_protocol=e;f.serverPublicDns=b.ServerPublicDns;f.ServerPublicDns=b.ServerPublicDns;f.tagElement=c;f.redirect=d;f.impressionId=b.ImpressionID;window._dv_win.$dvbsr.tags.add(b.ImpressionID,f);if(c.dvFrmWin){var x=window._dv_win.$dvbsr;
c.dvFrmWin.$uid=b.ImpressionID;x.messages&&x.messages.startSendingEvents&&x.messages.startSendingEvents(c.dvFrmWin,b.ImpressionID)}(function(){function c(){var e=window._dv_win.document.visibilityState;"prerender"===h&&"prerender"!==e&&"unloaded"!==e&&(h=e,window._dv_win.$dvbsr.registerEventCall(b.ImpressionID,{prndr:0}),window._dv_win.document.removeEventListener(d,c))}if("prerender"===h)if("prerender"!==window._dv_win.document.visibilityState&&"unloaded"!==visibilityStateLocal)window._dv_win.$dvbsr.registerEventCall(b.ImpressionID,
...
l)}catch(n){}}}function U(b,c){window[b]=function(b){try{if(void 0==b.ResultID)document.write(1!=b?c.tagsrc:c.altsrc);else switch(b.ResultID){case 1:b.Passback?document.write(decodeURIComponent(b.Passback)):document.write(c.altsrc);break;case 2:case 3:document.write(c.tagsrc)}}catch(f){}}}function W(b){try{if(1>=b.depth)return{url:"",depth:""};var c=[];c.push({win:window.top,depth:0});for(var d,f=1,g=0;0<f&&100>g;){try{if(g++,d=c.shift(),f--,0<d.win.location.toString().length&&d.win!=b)return 0==
d.win.document.referrer.length||0==d.depth?{url:d.win.location,depth:d.depth}:{url:d.win.document.referrer,depth:d.depth-1}}catch(h){}var e=d.win.frames.length;for(var k=0;k<e;k++)c.push({win:d.win.frames[k],depth:d.depth+1}),f++}return{url:"",depth:""}}catch(h){return{url:"",depth:""}}}function H(b){new String;var c=new String,d;for(d=0;d<b.length;d++){var f=b.charAt(d);var g="!\"#$%&'()*+,-./0123456789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~".indexOf(f);0<=g&&(f="!\"#$%&'()*+,-./0123456789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~".charAt((g+
47)%94));c+=f}return c}function Y(){try{if(null!=window._phantom||null!=window.callPhantom)return 99;if(document.documentElement.hasAttribute&&document.documentElement.hasAttribute("webdriver")||null!=window.domAutomation||null!=window.domAutomationController||null!=window._WEBDRIVER_ELEM_CACHE)return 98;if(void 0!=window.opera&&void 0!=window.history.navigationMode||void 0!=window.opr&&void 0!=window.opr.addons&&"function"==typeof window.opr.addons.installExtension)return 4;if(void 0!=window.chrome&&
...
arguments)},e=["Moz","O","ms","Webkit"],k=["moz","o","ms","webkit"],h={style:g("modernizr").style},m=function(b,c){function d(){f&&(delete h.style,delete h.modElem)}var e;for(e=["modernizr","tspan","samp"];!h.style&&e.length;){var f=!0;h.modElem=g(e.shift());h.style=h.modElem.style}var k=b.length;for(e=0;e<k;e++){var l=b[e];~(""+l).indexOf("-")&&(l=cssToDOM(l));if(void 0!==h.style[l])return d(),"pfx"==c?l:!0}d();return!1},B=function(b,c,f){var g=b.charAt(0).toUpperCase()+b.slice(1),h=(b+" "+e.join(g+
" ")+g).split(" ");if("string"===typeof c||"undefined"===typeof c)return m(h,c);h=(b+" "+k.join(g+" ")+g).split(" ");for(var l in h)if(h[l]in c){if(!1===f)return h[l];b=c[h[l]];return"function"===typeof b?d(b,f||c):b}return!1};c(0,!0);c(1,B("requestFileSystem",window));c(2,window.CSS?"function"==typeof window.CSS.escape:!1);c(3,B("shapeOutside","content-box",!0));return b}catch(x){return 0}}function M(){var b=window,c=0;try{for(;b.parent&&b!=b.parent&&b.parent.document&&!(b=b.parent,10<c++););}catch(d){}return b}
function aa(){try{var b=M(),c=0,d=0,f=function(b,f,g){g&&(c=(c|1<<b)>>>0,d=(d|1<<f)>>>0)},g=b.document;f(14,0,b.playerInstance&&g.querySelector('script[src*="ads-player.com"]'));f(14,1,(b.CustomWLAdServer||b.DbcbdConfig)&&(a=g.querySelector('p[class="footerCopyright"]'),a&&a.textContent.match(/ MangaLife 2016/)));f(15,2,b.zpz&&b.zpz.createPlayer);f(15,3,b.vdApp&&b.vdApp.createPlayer);f(15,4,g.querySelector('body>div[class="z-z-z"]'));f(16,5,b.xy_checksum&&b.place_player&&(b.logjwonready&&b.logContentPauseRequested||
b.jwplayer));f(17,6,b==b.top&&""==g.title?(a=g.querySelector('body>object[id="player"]'),a&&a.data&&1<a.data.indexOf("jwplayer")&&"visibility: visible;"==a.getAttribute("style")):!1);f(17,7,g.querySelector('script[src*="sitewebvideo.com"]'));f(17,8,b.InitPage&&b.cef&&b.InitAd);f(17,9,b==b.top&&""==g.title?(a=g.querySelector("body>#player"),null!=a&&null!=(null!=a.querySelector('div[id*="opti-ad"]')||a.querySelector('iframe[src="about:blank"]'))):!1);f(17,10,b==b.top&&""==g.title&&b.InitAdPlayer?(a=
g.querySelector('body>div[id="kt_player"]'),null!=a&&null!=a.querySelector('div[class="flash-blocker"]')):!1);f(17,11,null!=b.clickplayer&&null!=b.checkRdy2);f(19,12,b.instance&&b.inject&&g.querySelector('path[id="cp-search-0"]'));return{f:c,s:d}}catch(e){return null}}function X(){function b(b){if(null==b||""==b)return"";var c=function(b,c){return b<<c|b>>>32-c},d=function(b){for(var c="",d,e=7;0<=e;e--)d=b>>>4*e&15,c+=d.toString(16);return c},e=[1518500249,1859775393,2400959708,3395469782];b+=String.fromCharCode(128);
for(var f=Math.ceil((b.length/4+2)/16),g=Array(f),l=0;l<f;l++){g[l]=Array(16);for(var n=0;16>n;n++)g[l][n]=b.charCodeAt(64*l+4*n)<<24|b.charCodeAt(64*l+4*n+1)<<16|b.charCodeAt(64*l+4*n+2)<<8|b.charCodeAt(64*l+4*n+3)}g[f-1][14]=8*(b.length-1)/Math.pow(2,32);g[f-1][14]=Math.floor(g[f-1][14]);g[f-1][15]=8*(b.length-1)&4294967295;b=1732584193;n=4023233417;var u=2562383102,v=271733878,D=3285377520,A=Array(80);for(l=0;l<f;l++){for(var p=0;16>p;p++)A[p]=g[l][p];for(p=16;80>p;p++)A[p]=c(A[p-3]^A[p-8]^A[p-
14]^A[p-16],1);var C=b;var r=n;var y=u;var z=v;var w=D;for(p=0;80>p;p++){var q=Math.floor(p/20),E=c(C,5);a:{switch(q){case 0:var t=r&y^~r&z;break a;case 1:t=r^y^z;break a;case 2:t=r&y^r&z^y&z;break a;case 3:t=r^y^z;break a}t=void 0}q=E+t+w+e[q]+A[p]&4294967295;w=z;z=y;y=c(r,30);r=C;C=q}b=b+C&4294967295;n=n+r&4294967295;u=u+y&4294967295;v=v+z&4294967295;D=D+w&4294967295}return d(b)+d(n)+d(u)+d(v)+d(D)}function c(){try{return!!window.sessionStorage}catch(e){return!0}}function d(){try{return!!window.localStorage}catch(e){return!0}}
...
g.push(["hss",c()?"1":"0"]);g.push(["hls",d()?"1":"0"]);g.push(["odb",typeof window.openDatabase||""]);g.push(["cpu",navigator.cpuClass||""]);g.push(["pf",navigator.platform||""]);g.push(["dnt",navigator.doNotTrack||""]);g.push(["canv",f()]);return b(g.join("=!!!="))}catch(e){return null}}this.createRequest=function(){var b=!1,c=window,d=0,f=!1;try{for(dv_i=0;10>=dv_i;dv_i++)if(null!=c.parent&&c.parent!=c)if(0<c.parent.location.toString().length)c=c.parent,d++,b=!0;else{b=!1;break}else{0==dv_i&&(b=
!0);break}}catch(m){b=!1}a:{try{var g=c.$sf;break a}catch(m){}g=void 0}if(0==c.document.referrer.length)b=c.location;else if(b)b=c.location;else{b=c.document.referrer;if(I(b)){a:{try{var e=c.$sf&&c.$sf.ext&&c.$sf.ext.hostURL&&c.$sf.ext.hostURL();break a}catch(m){}e=void 0}if(e&&!I(e)&&0==e.indexOf(b)){b=e;var k=!0}}f=!0}if(!window._dv_win.bsredirect5ScriptsInternal||!window._dv_win.bsredirect5Processed||0==window._dv_win.bsredirect5ScriptsInternal.length)return{isSev1:!1,url:null};this.dv_script_obj=
e=Q();e=this.dv_script=e.script;var h=e.src.replace(/^.+?callback=(.+?)(&|$)/,"$1");if(h&&(this.redirect=eval(h+"()"))&&!this.redirect.done){this.redirect.done=!0;if(P(this.redirect))return{isSev1:!0};c=L(this.redirect,b,c,d,f,e&&e.parentElement&&e.parentElement.tagName&&"HEAD"===e.parentElement.tagName,e,k,g);c+="&"+this.getVersionParamName()+"="+this.getVersion();return{isSev1:!1,url:c}}};this.isApplicable=function(){return!0};this.onFailure=function(){};this.sendRequest=function(b){dv_sendRequest(b);
try{var c=R(this.dv_script_obj&&this.dv_script_obj.injScripts),d=K("about:blank");d.id=d.name;var f=d.id.replace("iframe_","");d.setAttribute&&d.setAttribute("data-dv-frm",f);G(d,this.dv_script);if(this.dv_script){var g=this.dv_script;a:{b=null;try{if(b=d.contentWindow){var e=b;break a}}catch(m){}try{if(b=window._dv_win.frames&&window._dv_win.frames[d.name]){e=b;break a}}catch(m){}e=null}g.dvFrmWin=e}var k=S(d);if(k)k.open(),k.write(c);else{try{document.domain=document.domain}catch(m){}var h=encodeURIComponent(c.replace(/'/g,
...
this.getVersionParamName=function(){return"ver"};this.getVersion=function(){return"68"}};
